...
maraca = Track.create!({ name: "Corrida em volta do maraca ", description: "2 voltas no maraca", level: 1, date: Date.parse('19-06-2020'), distance: 12, time_to_start: Time.parse("June 19 19:00"), time_to_complete: Time.parse("June 19 21:00"), start_address:'Avenida Maracanã, Rio de Janeiro', end_address:'Estátua do Bellini, Rio de Janeiro'})
...
lemeaoleblon = Track.create!({ name: " Rio Beach Run", description: "Run in Rio's beach ", level: 2, date: Date.parse('19-06-2020'), distance: 12, time_to_start: Time.parse("June 19 19:00"), time_to_complete: Time.parse("June 19 21:00"), start_address:'Pedra do Leme, Rio de Janeiro', end_address:'Mirante Leblon, Rio de Janeiro'})
